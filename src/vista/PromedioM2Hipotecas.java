...
public class PromedioM2Hipotecas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        promedioPropiedadCasa = new javax.swing.JLabel();
        promedioPropiedadDepartamento = new javax.swing.JLabel();
        ...
        contenedorPromedio.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 90, -1, -1));
        ...
        contenedorPromedio.add(promedioPropiedad, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 140, 390, 25));

        jLabel4.setBackground(new java.awt.Color(0, 0, 0));
        jLabel4.setFont(new java.awt.Font("Roboto", 1, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("Promedio en m2 de casas ");
        contenedorPromedio.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 180, -1, -1));

        promedioPropiedadCasa.setBackground(new java.awt.Color(187, 187, 187));
        promedioPropiedadCasa.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        promedioPropiedadCasa.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        promedioPropiedadCasa.setToolTipText("");
        promedioPropiedadCasa.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        contenedorPromedio.add(promedioPropiedadCasa, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 230, 390, 25));

        promedioPropiedadDepartamento.setBackground(new java.awt.Color(187, 187, 187));
        promedioPropiedadDepartamento.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        promedioPropiedadDepartamento.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        promedioPropiedadDepartamento.setToolTipText("");
        promedioPropiedadDepartamento.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        contenedorPromedio.add(promedioPropiedadDepartamento, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 320, 390, 25));

        jLabel5.setBackground(new java.awt.Color(0, 0, 0));
        jLabel5.setFont(new java.awt.Font("Roboto", 1, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("Promedio en m2 de departamentos");
        contenedorPromedio.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 270, -1, -1));
    ...
    private void botonCargarDatosInmuebleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonCargarDatosInmuebleActionPerformed
        ...
        for (String key : keys) {
            if (key != null) {
                ...
                System.out.println("Todo: "+tempCubiertos);
        ...
        //
        Set<String> keysCasa = mapPropiedad.keySet();

        int iCasa = 0, iDepartamento = 0;
        double valorCubiertosCasa = 0.0;
        double valorCasa = 0.0;
        double valorCubiertosDepartamento = 0.0;
        double valorDepartamento = 0.0;

        for (String key : keysCasa) {
            Propiedad p = LecturaArchivoInmueble.accesoADatos().get(key);
            if (p instanceof Casa) {
                String tempCubiertosCasa = mapPropiedad.get(key).getMetrosCuadradosCubiertos();
                System.out.println("Casa: "+tempCubiertosCasa);
                if (tempCubiertosCasa != null) {
                    valorCubiertosCasa = valorCubiertosCasa + Double.parseDouble(tempCubiertosCasa);
                }
                iCasa++;
            } else if (p instanceof Departamento) {
                String tempCubiertoDepartamento = mapPropiedad.get(key).getMetrosCuadradosCubiertos();
                System.out.println("Departamento: "+tempCubiertoDepartamento);
                if (tempCubiertoDepartamento != null) {
                    valorCubiertosDepartamento = valorCubiertosDepartamento + Double.parseDouble(tempCubiertoDepartamento);
                }
                iDepartamento++;
        ...
        Integer sumCasa = iCasa;
        valorCasa = Math.round((valorCubiertosCasa) / sumCasa);
        promedioPropiedadCasa.setText(Double.toString(valorCasa));

        Integer sumDepartamento = iDepartamento - 1;
        valorDepartamento = Math.round((valorCubiertosDepartamento) / sumDepartamento);
        System.out.println(valorDepartamento);
        promedioPropiedadDepartamento.setText(Double.toString(valorDepartamento));
    ...
    private javax.swing.JLabel promedioPropiedadCasa;
    private javax.swing.JLabel promedioPropiedadDepartamento;
